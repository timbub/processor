...
struct Code
{
    int* code; //TODO разбить на файлы
    size_t size_code;
};
...
int main(int argc, char* argv[])
{
    ...
    code_info.code = (int*) calloc(code_info.size_code, sizeof(int)); //TODO ctor_spu
...
void record_code(struct Code* code_info, FILE* input_file)
 {
    for(size_t i = 0; i < code_info->size_code; i++) //TODO fread 
    {
...
void run_code(struct Stack_t* stk, struct Code* code_info)
{
    for (size_t programm_options = 0; programm_options < code_info->size_code; programm_options++) //TODO rename ip
    {
        stack_elem_t x1 = 0;
        stack_elem_t x2 = 0;
        ...
        switch (code_info->code[programm_options])
            ...
            case 2: 
                stack_elem_t push; //TODO initial value
